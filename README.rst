...
preserve numerical robustness. You will need to scale coordinates using an appropriate factor, if you want to used fractional coordinates.

For more examples of use see `Clipper
